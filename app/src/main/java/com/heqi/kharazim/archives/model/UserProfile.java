...
public class UserProfile implements Serializable {
  ...
  public String getIdnumberother() {
    return idnumberother;
  }

  public void setIdnumberother(String idnumberother) {
    this.idnumberother = idnumberother;
  }
