...
import com.heqi.base.utils.ImageUtil;
import com.heqi.image.cache.ImageCacheUtils;
import com.heqi.image.cache.ImageMemoryCache;
import com.heqi.image.local.LocalImageClient;
...
public class ImageManager {
  ...
  private static RequestQueue newVolleyRequestQueue(Context context, Config config,
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
      ...
      stack =
          new HttpClientStack(HttpClients.createDefault());
    }
